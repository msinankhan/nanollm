from nanollm.tokenizer import get_tokenizer, RustBPETokenizer
...
train_docs=next(parquet_iter_batches(split='train'))
train_text='\n'.join(train_docs)
val_docs=next(parquet_iter_batches(split='val'))
val_text = '\n'.join(val_docs)
...
for tokenizer_name in ["gpt2",'gpt4','ours']:
    ...
    vocab_sizes[tokenizer_name]=vocab_size
...
print(f"\n Vocab Sizes:")
print(f"GPT2:{vocab_sizes["gpt2"]}")
print(f"GPT4:{vocab_sizes['gpt4']}")
print(f"RustBPE:{vocab_sizes['ours']}")


def print_comparison(baseline_name, baseline_results,our_results, all_text):
